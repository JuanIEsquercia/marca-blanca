...
export const TOOLS: Anthropic.Tool[] = [
  ...
  },
  {
    ...
    description: 'Devuelve TODO lo pendiente de cobrar en toda la empresa (o en un proyecto puntual si se indica): cobros de obra sin cobrar y cuotas de venta de unidades sin cobrar, juntos. Cada resultado de obra trae un campo "certificado" — puede ser un certificado real (N° y período) o "sin certificado (anticipo/seña/cobro suelto)": NO todos los cobros vienen de un certificado, respetá lo que devuelve la tool en vez de asumir que todo es "un certificado". Uso OBLIGATORIO cuando el usuario pregunta en general "¿qué tengo pendiente de cobrar?", "¿qué me deben?", sin nombrar un contrato puntual — no le pidas que primero especifique el proyecto o contrato, esta tool ya barre todo lo que puede ver. Si en cambio ya sabés el contrato exacto (el usuario lo nombró), usá mejor listar_certificados_contrato, que da más detalle por certificado.',
    input_schema: {
      type: 'object',
      properties: {
