...
-- ============================================================
-- MIGRATION 072: hardening auditoría 2026-08-24 — ver migration_072.sql
-- ============================================================
...
-- ============================================================
-- MIGRATION 073: control de obra (presupuestado vs. ejecutado por
-- rubro) — ver migration_073.sql
-- ============================================================
...
-- ============================================================
-- MIGRATION 074: Control de obra con módulo de permiso propio —
-- resumen_rubros_obra pasa a SECURITY DEFINER con chequeos adentro.
-- Ver migration_074.sql.
-- ============================================================
CREATE OR REPLACE FUNCTION resumen_rubros_obra(p_obra_id UUID)
RETURNS TABLE(
  rubro               TEXT,
...
-- ============================================================
-- MIGRATION 077: bandeja de pendientes del panel — ver migration_077.sql
-- ============================================================
...
-- ============================================================
-- MIGRATION 078: series de índices y cotizaciones (BCRA) —
-- ver migration_078.sql
-- ============================================================
...
-- ============================================================
-- MIGRATION 079: cuotas ajustables por índice e interés por mora —
-- ver migration_079.sql
-- ============================================================
