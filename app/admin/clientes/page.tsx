  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Compradores de unidades y clientes de obra — datos compartidos con Presupuestos, Contratos, Reservas y Ventas</p>
      </div>
      <CompradoresManager
